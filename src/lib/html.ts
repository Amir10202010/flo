 ...
 *
 * Safe *rendering* of HTML message bodies (allowlist sanitisation for
 * `dangerouslySetInnerHTML`) lives in `./sanitize-email` — kept separate so the
 * `sanitize-html` parser never lands in a client bundle.
 */
